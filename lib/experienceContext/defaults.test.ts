...
// Covers "unavailable source" for the agenda slice: this is the exact
// object collectSharedExperienceContext's per-provider failure isolation
// leaves in the Pool when the agenda Provider throws (network or database
// error -- see agendaProvider.test.ts). Run with:
