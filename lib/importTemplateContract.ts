...
export const AGENDA_IMPORT_TEMPLATE_CONTRACT: ImportTemplateContract = {
  ...
  fields: [
    ...
    { key: "agenda_date", preferredHeading: "Agenda Date", aliases: ["Agenda Date", "AgendaDate", "Date", "date", "agenda_date", "AGENDA DATE"], required: true, format: "date", instructions: "Required. Recommended format YYYY-MM-DD; MM/DD/YYYY is also accepted.", sample: "2026-09-12" },
    { key: "start_time", preferredHeading: "Start Time", aliases: ["Start Time", "start_time", "Start", "start"], required: true, format: "time", instructions: "Required. 24-hour HH:MM.", sample: "08:00" },
    { key: "end_time", preferredHeading: "End Time", aliases: ["End Time", "end_time", "End", "end"], required: false, format: "time", instructions: "Optional. 24-hour HH:MM.", sample: "09:00" },
