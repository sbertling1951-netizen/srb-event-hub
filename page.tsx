    ...
    <div style={{ padding: 30 }}>
      ...
      >
        ...
        >
          ...
          <p>Find members by name, site number, membership number, or coach info.</p>
        </a>
        ...
        >
          ...
          <p>View the event schedule, activity times, and key rally information.</p>
        </a>
        ...
        >
          ...
          <p>See nearby fuel, groceries, urgent care, pharmacy, and other services.</p>
        </a>
        ...
        >
          ...
          <p>Upload registration CSV files and load attendee data into the app.</p>
        </a>
        ...
        >
          ...
          <p>Place site markers on the campground map and assign attendees to sites.</p>
        </a>
      </div>
    </div>
  )
