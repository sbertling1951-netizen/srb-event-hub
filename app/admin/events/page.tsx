...
function EventAdminPageInner() {
  ...
  async function loadAssignmentsForEvent(eventId: string) {
    try {
      ...
      if (mapSettingsResult.error) throw mapSettingsResult.error;
      if (nearbyAssignmentResult.error) throw nearbyAssignmentResult.error;
