  ...
  async function saveMembershipNumber(item: ReviewItem) {
    ...
    try {
      ...
      const { error: attendeeError } = await supabase
        .from("attendees")
        .update({ membership_number: draftValue, data_status: "corrected" })
    ...
    <div style={{ display: "grid", gap: 18 }}>
      ...
      >
        <div className="card" style={{ padding: 18, display: "grid", gap: 14 }}>
          <div>
            <h2 style={{ marginTop: 0, marginBottom: 6 }}>Attendee Management</h2>
            <div style={{ fontSize: 14, opacity: 0.8 }}>
        ...
        <div className="card" style={{ padding: 18, display: "grid", gap: 14 }}>
          <div>
            ...
            <div style={{ fontSize: 14, opacity: 0.8 }}>
              Review queue status and quick correction workflow for attendee data.
            </div>
          </div>
