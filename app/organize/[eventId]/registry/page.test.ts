...
test("the ordinary read tries the catalog-aware list first and falls back to the plain list only on identity_resolution_required", () => {
  ...
  // any OTHER error is rethrown, not swallowed into a silent fallback
