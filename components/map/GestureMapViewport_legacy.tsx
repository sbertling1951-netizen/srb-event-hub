  ...
  return (
    <div
      ...
      onTouchEnd={(e) => {
        ...
        const wasDragging = viewportRef.current?.dataset.isDragging === "true";

        if (viewportRef.current) {
          viewportRef.current.dataset.isDragging = "false";
        }
        ...
        if (viewportRef.current) {
          ...
          requestAnimationFrame(() => {
            setTimeout(() => {
              currentViewport.dataset.lastTapTime = "0";
            }, 350);
          });
        }
        ...
        const targetScale = Math.min(currentScale * 1.8, maxScale);
